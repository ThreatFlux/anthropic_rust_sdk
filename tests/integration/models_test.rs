...
mod models_api_tests {
    ...
    async fn test_list_models_with_pagination() {
        ...
        let pagination = Pagination::new().with_limit(10).with_after("cursor_123");
    ...
    async fn test_list_models_with_capabilities() {
        ...
        Mock::given(method("GET"))
            .and(path("/v1/models"))
            .respond_with(ResponseTemplate::new(200).set_body_json(&models_with_capabilities))
            .mount(&mock_server)
            .await;
        ...
        assert!(model.supports_vision());
        assert!(model.supports_tools());
        assert!(model.has_capability("computer_use"));
    }
    ...
    async fn test_model_family_detection() {
        ...
        Mock::given(method("GET"))
            .and(path("/v1/models"))
            .respond_with(ResponseTemplate::new(200).set_body_json(&various_models))
            .mount(&mock_server)
            .await;
    ...
    async fn test_deprecated_models() {
        ...
        Mock::given(method("GET"))
            ...
            .respond_with(ResponseTemplate::new(200).set_body_json(&deprecated_model))
            .mount(&mock_server)
            .await;
    ...
    async fn test_model_pricing_info() {
        ...
        Mock::given(method("GET"))
            ...
            .respond_with(ResponseTemplate::new(200).set_body_json(&model_with_pricing))
            .mount(&mock_server)
            .await;
    ...
    async fn test_models_pagination_has_more() {
        ...
        Mock::given(method("GET"))
            ...
            .respond_with(ResponseTemplate::new(200).set_body_json(&response_with_more))
            .mount(&mock_server)
            .await;
